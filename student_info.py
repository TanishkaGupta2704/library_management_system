...
class student:
    def __init__(self,root):
        ...
        c.execute("SELECT name FROM sel_students4")
        rows=c.fetchone()
        row=rows[0]
        print(rows)
        ...
        c.execute("SELECT rollno FROM sel_students4")
        rows1=c.fetchone()
        row1=rows1[0]
        print(rows1)
        ...
        c.execute("SELECT Issue_book FROM sel_students4")
        rows2=c.fetchone()
        row2=rows2[0]
        print(rows2)
        ...
        c.execute("SELECT Issue_date FROM sel_students4")
        rows3=c.fetchone()
        row3=rows3[0]
        print(rows3)
        ...
        c.execute("SELECT Fine FROM sel_students4")
        rows4=c.fetchone()
        row4=rows4[0]
        print(rows4)
        ...
        c.execute("SELECT year FROM sel_students4")
        rows5=c.fetchone()
        row5=rows5[0]
        print(rows5)
