...
from audiobooks_database import*
from about_us import About_us
from student_databse import * 
...
# logo
        ...
        l2.place(x=0, y=0)
# side image
        I2 = Image.open(r"C:\Users\asus\OneDrive\Pictures\nitkkr1.jpg")
        new_img2 = I2.resize((1400, 120))
        my_img2 = ImageTk.PhotoImage(new_img2)
        I3 = Image.open(r"C:\Users\asus\OneDrive\Pictures\Library.jpg")
        ...
        def open_login_page():
            ...
            def Myclick():
                ...
                if user_type == "student":
                    ...
                    c.execute("SELECT * FROM admins1 WHERE name=? AND adminId=?", (username, password))
                ...
                if user_data:
                    if user_type == "student":
                        ...
                        name, roll,books,year, idate, fine= user_data
...
# title
        lbl_title=Label(root,text="LIBRARY MANAGEMENT SYSTEM",font=("comic sans ms",18,"bold"),bg="#77B0AA",relief=SUNKEN)
        ...
        text_id=my_canvas1.create_text(0, 60, text=our_quotes[0], anchor='nw', font=("Pristina", 22, "bold"),fill="white")
