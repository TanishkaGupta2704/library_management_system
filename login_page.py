...
from file_1 import Libsystem
from admin_page import Libsystem1
...
class Login:
    def __init__(self,root):
        ...
        self.root.iconbitmap(r"C:\Users\asus\OneDrive\Pictures\login_image.png")
        ...
        def Myclick():
            def verify_login_details(user_type, username, password):
                ...
                if user_type == "Student":
                    c.execute("SELECT * FROM students2 WHERE name=? AND roll=?", (username, password))
                ...
                if user_type=="Student":
                    ...
                    conn1=sqlite3.connect("selected_database.db")
                    c1=conn1.cursor()
                    print(user_data)

                    c1.execute('''DELETE FROM sel_students4''')
                    c1.execute('''INSERT INTO sel_students4 (name, rollno,year, Issue_book, Issue_date, Fine)
